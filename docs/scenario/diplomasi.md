...
| Tür | Dış politika | Vergi / asker | Ayrılma veya değişme meselesi |
|---|---|---|---|
| Özerk bağlılık | Üst devlet izni olmadan saldırı antlaşması yapamaz; yerel ticaret serbestliği sınırlı | Sabit yıllık katkı, sınırlandırılmış sefer kotası; merkez keyfî yeni yük koyamaz | Sözleşmenin ihlali, yerel meclis ve karşılıklı müzakere |
| Koruma antlaşması | Dış savunma koruyucuda; iç yönetim ve din işleri yerelde | Koruma giderine katkı; otomatik bütün gümrüğün devri yok | Güvenliği sağlayamama veya hukuka müdahale antlaşmayı tartışmaya açar |
| Ortak taç | Hükümdar ortak, maliye/yasalar ayrı; dış politika müşterek kurumdan | Pazarlık edilmiş filo/ordu katkıları | Veraset ve anayasa uzlaşması; bir taraf diğerinin sömürgesi değil |
| Konfederasyon | Üyelerin ayrı egemenliği; ortak savunma konsey onayıyla | Ortak projeye açık katkı; varsayılan sürekli tek merkez vergisi yok | Tüzükte arabuluculuk ve çıkış müzakeresi |
| Sömürge şartı | Dış egemenlik metropolde; iç meclis gücü koloniye göre farklı | Yerel bütçe + belirlenmiş transfer ve ticaret tercihi | Temsil, mali hak, kölelik ve toprak anlaşmaları |
| Haraç/ziyaret antlaşması | Tam dış savunma devri olmak zorunda değil | Sınırlı mal/para veya törensel katkı | Egemenlik, ticaret erişimi ve koruma karşılığının ayrı pazarlığı |
| Bağımsızlık garantisi | Egemen devlet kendi dış politikasını yürütür | Otomatik vergi/asker teslimi yok | Garanti, saldırı halinde diplomatik yükümlülük; ülkenin mülkü olmak değil |
| Liman/şirket sözleşmesi | Ev sahibi egemenliğini korur | Kira, tarife ve sınırlı garnizon/mahkeme hakları | Süre, fesih, yargı ve vergi uyuşmazlığı |

## 2. Başlangıçta mevcut bağlılık ve birlikler

| Üst/ortak makam | Taraflar | 1836 sözleşmesi | Başlangıç gerilimi |
|---|---|---|---|
...
**Özellikle bağlı olmayanlar:** altı Fransız devleti, Basra, Kürdistan, Şam, Cebel-i Lübnan, Kudüs, Buhara, Hive, Hokand, Bakü, Novgorod, Sahel devletleri. Kültürel yakınlık veya bir imparatorun iddiası tabiiyet yaratmaz.

## 3. Bağımsızlık ve geçiş antlaşmaları

| Antlaşma | Taraflar / temel hüküm | 1836'da aşınan bölüm |
|---|---|---|
| Şam, 1712 | Mısır ve Rûm; Levant yönetimleri kabul edilen ayrı taraflar. Kutsal yer ve hac/ziyaret gelirlerine karışmama | Vakıf denetimi, mülteci geçişi, Halep–Şam tarifesi |
...
Bağımsızlık garantileri sonsuz otomatik savaş sözleri değildir; ilgili ülkenin meclis ve kapasitesi yükümlülüğün yerine getirilmesini tartışmaya açabilir. Taslak, bu siyaseti oyuncuya seçenek olarak sunar.

## 4. Rekabet ve işbirliği matrisi

| Eksen | Rekabetin maddi nedeni | İşbirliği nedeni | İlk diplomatik kriz konusu |
|---|---|---|---|
| Rûm–Mısır | Levant, Kıbrıs, donanma ve dinî hakemlik | Pamuk–kömür ticareti, hac yolları, korsanlıkla mücadele | Bir Levant vakfının vergilendirilmesi |
| Rûm–İran | Irak/Kafkasya hak iddiası, tarife ve sınır komutası | Makine parçaları, tahıl, karşılıklı kredi | Erzurum–Tebriz geçişinin kapanması |
| Mısır–Umman | Kızıldeniz/Hint Okyanusu sigorta ve liman gelirleri | Ortak deniz güvenliği ve tahıl | Zanzibar tüccarlarının Mısır tarifesine itirazı |
| Endülüs–Fas | Atlantik imtiyazı ve Brezilya kredisi | Ortak sermaye, göç ve İberya güvenliği | Fas gemilerine koloni ticaretinde eşit erişim |
| Endülüs–Britanya–Hollanda | Kıyı kolonileri, navlun ve makine piyasası | Tedarik, finans, tarafsız limanlar | Koloni kaçak ticaret gemisine el koyma |
...
## 5. Üç Minber için sınır

Dinî yakınlık bu tablolara otomatik ittifak, gümrük birliği veya bağlılık eklemez. Meşruiyet; hac güvenliği, eğitim bursu, arabuluculuk, azınlık/cemaat haklarına riayet ve gelir aktarımının adaleti üzerinden kazanılır. Mısır ile bir Sahel devletinin aynı yorumu benimsemesi aradaki mesafeyi, yerel hukuku ve yerel iktidarı yok etmez.

Hiçbir kriz tek seçenekli “tarihte oldu, şimdi de olsun” olayına bağlanmayacak. Tedarik ve antlaşmalar devam ediyorsa savaş istemeyen aktörün makul bir yolu bulunmalıdır.
