"""Freeze Mexican, Central American and Caribbean POPs before this demographic phase."""
...
POPS = ROOT / "common/history/pops/tgc_pops.txt"
...
def main() -> None:
    ...
    if len(targets) != 35 or {key.split("/")[1] for key in targets} != set(plan["countries"]):
