...
```mermaid
flowchart LR
  A[Vakıf ve kent okulları] --> B[Okuryazar işgücü]
  C[Akademi ve atölye] --> D[Tasarım ve usta yetiştirme]
  B --> E[Üretim yeteneği]
  D --> E
  F[Yakıt ve maden] --> G[İşleyen fabrika]
  E --> G
  H[Kredi ve mülkiyet güvencesi] --> G
  I[Yol liman ve gıda] --> G
  G --> J[Vergi ve özel gelir]
  J --> A
  J --> H
  G --> K[İşçi siyaseti ve çevre baskısı]
```
