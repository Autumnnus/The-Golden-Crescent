...
Usage:
    python3 scripts/maintenance/auto_continue_codex.py                    # Defaults to 06:35:15
    python3 scripts/maintenance/auto_continue_codex.py --seconds 10       # Test mode: triggers in 10 seconds
    python3 scripts/maintenance/auto_continue_codex.py --time 06:35:30    # Custom target time (HH:MM:SS)
"""
