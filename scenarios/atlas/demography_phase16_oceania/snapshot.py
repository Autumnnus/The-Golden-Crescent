"""Freeze generated Oceania POPs after the narrow Samoa political correction."""
...
def main() -> None:
    ...
    parser.add_argument("--pops", default="build/scenarios/oceania-political/common/history/pops/tgc_pops.txt")
    ...
    pops = (ROOT / args.pops).resolve()
    if not pops.is_relative_to(ROOT / "build"):
        raise ValueError("POP source must stay in this mod's build directory")
