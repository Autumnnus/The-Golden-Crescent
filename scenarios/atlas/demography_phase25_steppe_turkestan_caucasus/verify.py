"""Audit the steppe, Turkestan, Caucasus and Afghanistan POP plan and protected world data."""
...
BASE = "steppe-turkestan-caucasus"
...
def main() -> None:
    ...
    errors = []
    if len(target) != 54 or set(frozen) != target or set(plan["shares"]) != target:
