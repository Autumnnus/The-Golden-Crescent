"""Freeze North American POPs after the Alaska/Texas owner correction, before demography."""
...
POPS = ROOT / "build/scenarios/north-america-political/common/history/pops/tgc_pops.txt"
...
def main() -> None:
    ...
    if len(targets) != 95 or {key.split("/")[1] for key in targets} != set(plan["countries"]):
