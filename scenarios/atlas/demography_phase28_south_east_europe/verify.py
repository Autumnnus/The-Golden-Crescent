"""Audit the Southern and Eastern European POP plan and protected world data."""
...
def main() -> None:
    ...
    errors = []
    if len(target) != 61 or set(frozen) != target or set(plan["shares"]) != target:
